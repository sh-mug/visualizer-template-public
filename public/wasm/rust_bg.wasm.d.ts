...
export function __wbg_get_ret_pos(a: number, b: number): void;
export function __wbg_set_ret_pos(a: number, b: number, c: number): void;
export function __wbg_get_ret_vel(a: number, b: number): void;
export function __wbg_set_ret_vel(a: number, b: number, c: number): void;
